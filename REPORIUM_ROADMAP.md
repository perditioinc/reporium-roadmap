...
|---|---|---|---|
| 1 | reporium-api | PR #435 (NullPool /health) | follow-up shipped today as `e9d1a97` |
| 2 | reporium-api | PR #436 (stale Cloud Run candidate-tag cleanup) | review |
| 3 | reporium-ingestion | Nightly Graph Build investigation | diagnostics added (PR #66, follow-up `025a60b`) |
...
Fix shipped as `e9d1a97` after PR #435.
